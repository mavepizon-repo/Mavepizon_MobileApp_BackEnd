...
public class TelecallingController {
    ...
    public ResponseEntity<Page<TelecallingEnquiry>> getAllEnquiries(
            @RequestHeader("Authorization") String authHeader,
            @PageableDefault(size = 20, sort = "id") Pageable pageable) {

        return ResponseEntity.ok(
                telecallingService.getAllEnquiries(authHeader, pageable));
    }
    ...
    public ResponseEntity<Page<TelecallingFollowup>>
    getCustomFollowups(
            @RequestHeader("Authorization") String authHeader,
            @PageableDefault(size = 20, sort = "id") Pageable pageable) {
    ...
    @PutMapping("/update/{enquiryId}/{status}")
