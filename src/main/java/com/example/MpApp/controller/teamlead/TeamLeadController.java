...
public class TeamLeadController {
    ...
    public ResponseEntity<?> login(
            @Valid @RequestBody TeamLeadLoginRequest request) {
    ...
    public ResponseEntity<Page<OfficeStaffResponseDTO>> getAllStaff(
            @RequestHeader("Authorization") String authHeader,
            @PageableDefault(size = 20, sort = "id") Pageable pageable) {
        return ResponseEntity.ok(service.getAllStaff(pageable));
    }
    ...
    public ResponseEntity<Page<CollegeStaff>>
    getAllCollegeStaff(@PageableDefault(size = 20, sort = "id") Pageable pageable) {
    ...
    public ResponseEntity<Page<Student>>
    getAllStudents(
            @PathVariable Long teamLeadId,
            @PageableDefault(size = 20, sort = "id") Pageable pageable) {

        return ResponseEntity.ok(
                service.getAllStudents(teamLeadId, pageable)
        );
    }
    ...
    public ResponseEntity<Page<OfficeStaffLeave>> getAllOfficeStaffLeaveRequests(
            @PageableDefault(size = 20, sort = "id") Pageable pageable) {

        return ResponseEntity.ok(
                service.getAllOfficeStaffLeaves(pageable)
        );
    }
