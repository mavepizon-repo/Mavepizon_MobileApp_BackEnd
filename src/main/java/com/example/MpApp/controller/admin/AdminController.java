...
public class AdminController {
    ...
    public ResponseEntity<?> login(
            @Valid @RequestBody com.example.MpApp.dto.admin.AdminLoginRequest request) {
    ...
    @GetMapping("/teamlead")
    public ResponseEntity<?> getAllTeamLeads(@PageableDefault(size = 20, sort = "id") Pageable pageable) {

        return ResponseEntity.ok(
                service.getAllTeamLeads(pageable)
        );
    }
    ...
    @GetMapping("/staff")
    public ResponseEntity<?> getAllStaff(@PageableDefault(size = 20, sort = "id") Pageable pageable) {

        return ResponseEntity.ok(
                service.getAllStaff(pageable)
        );
    }
    ...
    public ResponseEntity<?> getAllCollegeStaff(
        ...
        return ResponseEntity.ok(
                service.getAllCollegeStaff(pageable)
        );
    }
    ...
    public ResponseEntity<?> getAllStudents(
        ...
        service.validateAdminToken(auth);
        return ResponseEntity.ok(service.getAllStudents(page, size, sort, direction, search));
    }
    ...
    public ResponseEntity<?> getAllTeamLeadLeaveRequests(@PageableDefault(size = 20, sort = "id") Pageable pageable) {

        return ResponseEntity.ok(
                service.getAllTeamLeadLeaveRequests(pageable)
        );
    }
