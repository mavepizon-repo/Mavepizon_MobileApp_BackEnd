...
public class AdminService {
    ...
    private String generateTeamLeadId(String branch) {
        ...
        return "MP" + branchCode + "TL" + String.format("%03d", teamLeadRepository.nextBusinessId());
    }
    ...
    public Map<String, String> registerAdmin(Admin admin) {
        ...
        PasswordPolicy.validate(admin.getPassword());
    ...
    public Map<String, String> createTeamLead(
        ...
        PasswordPolicy.validate(teamLead.getPassword());
    ...
    public Page<TeamLead> getAllTeamLeads(Pageable pageable) {
        return teamLeadRepository.findAll(pageable);
    }
    ...
    public Page<OfficeStaff> getAllStaff(Pageable pageable) {
        return officeStaffRepository.findAll(pageable);
    }
    ...
    public Page<Student> getAllStudents(int page, int size, String sort, String direction, String search) {
        ...
        return studentRepository.findByNameContainingIgnoreCaseOrEmailContainingIgnoreCaseOrStudentIdContainingIgnoreCase(
    ...
    public Page<TeamLeadLeave>
    getAllTeamLeadLeaveRequests(Pageable pageable) {
        return teamLeadLeaveRepository.findAll(pageable);
    }
    ...
    getAdminDashboardStats() {
        ...
        double avgTeamLeadPerformance =
                teamLeadRepository.averagePerformanceScore() != null
                        ? teamLeadRepository.averagePerformanceScore()
                        : 0.0;
