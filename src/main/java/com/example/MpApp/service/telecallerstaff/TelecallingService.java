...
public class TelecallingService {
    ...
    public Page<TelecallingEnquiry> getAllEnquiries(String authHeader, Pageable pageable) {
        String email = extractEmail(authHeader);
        OfficeStaff staff = officeStaffRepository.findByEmail(email).orElseThrow(
                () -> new RuntimeException("Staff member not found.")
        );
        ...
        validateTelecaller(staff.getId());
        return enquiryRepository.findAllByStaffId(staff.getId(), pageable);
    }
    ...
    public TelecallingEnquiry getEnquiryById(String authHeader, Long enquiryId) {
        ...
        validateTelecaller(staff.getId());
        return getOwnedEnquiry(enquiryId, staff.getId());
    }
    ...
    public Map<String, String> updateEnquiry(String authHeader, Long enquiryId, TelecallingUpdateRequest request) {
        ...
        TelecallingEnquiry enquiry = getOwnedEnquiry(enquiryId, staff.getId());
    ...
    public void deleteEnquiry(String authHeader, Long enquiryId) {
        ...
        validateTelecaller(staff.getId());
        getOwnedEnquiry(enquiryId, staff.getId());
    ...
    public List<TelecallingEnquiry> filterByCollege(String authHeader, String collegeName) {
        ...
        validateTelecaller(staff.getId());
        return enquiryRepository.findByStaffIdAndCollegeNameContainingIgnoreCase(staff.getId(), collegeName);
    }
    ...
    public List<TelecallingEnquiry> filterByStatus(String authHeader, EnquiryStatus status) {
        ...
        validateTelecaller(staff.getId());
        return enquiryRepository.findByStaffIdAndStatus(staff.getId(), status);
    }
    ...
    public List<TelecallingEnquiry> filterByStudentName(String authHeader, String studentName) {
        ...
        validateTelecaller(staff.getId());
        return enquiryRepository.findByStaffIdAndStudentNameContainingIgnoreCase(staff.getId(), studentName);
    }
    ...
    public List<TelecallingEnquiry> filterByDate(String authHeader, LocalDate date) {
        ...
        validateTelecaller(staff.getId());
        return enquiryRepository.findByStaffIdAndEnquiryDate(staff.getId(), date);
    }
    ...
    public List<TelecallingEnquiry> getTodayFollowups(String authHeader) {
        ...
        return enquiryRepository.findByStaffIdAndNextFollowupDate(staff.getId(), LocalDate.now());
    }

    public List<TelecallingFollowup> getOverdueFollowups(Long staffId) {
        validateTelecaller(staffId);
        return followupRepository.findByEnquiryStaffIdAndNextFollowupDateBefore(staffId, LocalDate.now());
    }
    ...
    public Page<TelecallingFollowup> getCustomFollowups(String authHeader, Pageable pageable) {
        String email = extractEmail(authHeader);
        OfficeStaff staff = officeStaffRepository.findByEmail(email).orElseThrow(
                () -> new RuntimeException("Staff member not found.")
        );
        validateTelecaller(staff.getId());
        return followupRepository.findAllByEnquiryStaffId(staff.getId(), pageable);
    }
    ...
    @Transactional
    public Map<String, String> addFollowup(
            String authHeader,
            Long enquiryId,
            TelecallingFollowupRequest request
    ) {
        ...
        OfficeStaff staff =
                officeStaffRepository.findByEmail(email)
                        .orElseThrow(() ->
                                new RuntimeException("Staff member not found.")
                        );

        // Validate TELECOM_SERVICE staff
        OfficeStaff telecaller =
                validateTelecaller(staff.getId());

        // Only the staff member who owns the enquiry may add followups.
        TelecallingEnquiry enquiry = getOwnedEnquiry(enquiryId, staff.getId());

        // Create followup
        TelecallingFollowup followup =
                new TelecallingFollowup();
        ...
        TelecallingFollowup savedFollowup =
        ...
        response.put(
                "message",
                "Enquiry Followup Milestone Logged Successfully"
        );
    ...
    public List<TelecallingFollowup> getFollowupHistory(
            String authHeader,
            Long enquiryId
    ) {
        ...
        return followupRepository.findByEnquiryIdAndEnquiryStaffId(
    ...
    private TelecallingEnquiry getOwnedEnquiry(Long enquiryId, Long staffId) {
    ...
    @Transactional
    public Map<String, String> updateEnquiryStatus(Long enquiryId,EnquiryStatus status,String authHeader) {
        String email = extractEmail(authHeader);
        OfficeStaff staff = officeStaffRepository.findByEmail(email).orElseThrow(
                () -> new RuntimeException("Staff member not found.")
        );
        ...
        Map<String, String> response = new HashMap<>();
        response.put("enquiryId", enquiry.getId().toString());
