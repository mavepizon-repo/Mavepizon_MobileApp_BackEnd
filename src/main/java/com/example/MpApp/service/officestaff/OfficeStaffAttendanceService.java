...
public class OfficeStaffAttendanceService {
    ...
    */
    ...
    public Map<String,String> markHolidayOD(LocalDate holidayDate) {
        int page = 0;
        Page<OfficeStaff> staffPage;
        do {
            staffPage = staffRepository.findAll(PageRequest.of(page++, 200));
            for (OfficeStaff staff : staffPage.getContent()) {
    ...
    */
    public Map<LocalDate, java.util.List<Map<String, Object>>> getLeavesByDateRange(LocalDate start, LocalDate end) {
        ...
        List<OfficeStaffAttendance> records = attendanceRepository.findByAttendanceDateBetween(start, end);
