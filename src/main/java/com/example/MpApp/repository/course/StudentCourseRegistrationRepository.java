...
//    for getting the details of students who only done the payment,for preparing the certificate
    List<StudentCourseRegistration> findByPaymentStatus(String paymentStatus);

    List<StudentCourseRegistration> findByPaymentStatusIn(List<String> paymentStatuses);
}